const projectData = [
    {
        ...
        tasks: 78,
        comments: 214,
        member: ['assets/images/users/user-1.jpg', 'assets/images/users/user-2.jpg', 'assets/images/users/user-3.jpg',
            'assets/images/users/user-4.jpg', 'assets/images/users/user-5.jpg'],
        progressValue: 28
    },
    {
        ...
        tasks: 81,
        comments: 103,
        member: ['assets/images/users/user-6.jpg', 'assets/images/users/user-7.jpg', 'assets/images/users/user-8.jpg'],
        progressValue: 55
    },
    {
        ...
        tasks: 42,
        comments: 65,
        member: ['assets/images/users/user-9.jpg', 'assets/images/users/user-10.jpg', 'assets/images/users/user-1.jpg',
    ...
    },
    {
        ...
        tasks: 95,
        comments: 97,
        member: ['assets/images/users/user-5.jpg', 'assets/images/users/user-8.jpg', 'assets/images/users/user-9.jpg'],
        progressValue: 70
    },
    {
        ...
        tasks: 36,
        comments: 78,
        member: ['assets/images/users/user-3.jpg', 'assets/images/users/user-4.jpg', 'assets/images/users/user-5.jpg',
