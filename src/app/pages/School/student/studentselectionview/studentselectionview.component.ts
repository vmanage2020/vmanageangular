...
@Component({
  selector: 'app-studentselectionview',
  templateUrl: './studentselectionview.component.html',
  styleUrls: ['./studentselectionview.component.scss']
})
export class StudentselectionviewComponent implements OnInit {
