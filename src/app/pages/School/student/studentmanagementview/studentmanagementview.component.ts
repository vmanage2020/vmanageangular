...
@Component({
  selector: 'app-studentmanagementview',
  templateUrl: './studentmanagementview.component.html',
  styleUrls: ['./studentmanagementview.component.scss']
})
export class StudentmanagementviewComponent implements OnInit {
