...
/**
 * Form Wizard component - handling the Form wizard with sidebar and content
 */
export class WizardComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.breadCrumbItems = [{ label: 'UBold', path: '/' }, { label: 'Forms', path: '/' }, { label: 'Form Wizard', path: '/', active: true }];
